      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/bhukanbhavdip/real_time_face_detect" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://bhukanbhavdip.github.io/real_time_face_detect/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>Real Time Face Detect Web App</h3>
              <p> Real-Time Face Detection Web App using ML5.js, Face API, and ReactJS: This web application utilizes ML5.js and Face API for real-time face detection, landmark detection, and expression recognition. Built with ReactJS, it provides an interactive and responsive interface for users to access their device's webcam and instantly detect faces, visualize facial landmarks, and recognize expressions.</p>
            </div>
            <footer> <ul className="tech-list"> <li>Face-api</li> <li>React JS</li> <li>ml5.js</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>User Task Management</h3>
              <p>
              User Task Management Full Stack App using MERN Stack: This comprehensive application empowers users to efficiently manage tasks with added features for pagination, sorting, searching, and filtering. Built with the MERN stack (MongoDB, Express.js, React.js, Node.js), users can create, edit tasks seamlessly while leveraging advanced functionality. With MongoDB providing a flexible and scalable database solution, Express.js handling API requests, React.js powering the interactive user interface, and Node.js supporting server-side processing and real-time updates, this application offers a seamless and efficient experience for task management with enhanced usability and functionality.
              </p>
            </div>
            <footer>
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                ...
                <a href="https://amazontsellertool.vercel.app/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Amazon Seller Tool</h3>
              <p>
              Amazon Seller Tool! The combination of React.js for the frontend, MongoDB for data storage, and Express.js for the backend creates a solid foundation for scalability and flexibility. Developing algorithms to calculate Amazon's commissions, fees, and profit margins is crucial for sellers. Plus, the user-friendly interface I've built with React.js likely enhances the overall user experience, making it easier for sellers to input data and obtain instant profit calculations. Reducing seller time by up to 95% is a significant achievement and speaks to the efficiency of this tool.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/bhukanbhavdip/url_shortener" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              <h3>URL Shortener</h3>
              <p>The URL Shortener project is a web application built using Node.js that allows users to shorten long URLs into more manageable and shareable links. The application utilizes the EJS (Embedded JavaScript) template engine to render dynamic HTML content for the user interface.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Node JS</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/bhukanbhavdip/movie-central" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              <h3>Movie Website Using OMDB API</h3>
              <p>Movie Central is a React.js-powered website leveraging the OMDB API, offering users a seamless browsing experience to discover, search, and explore movies. With its intuitive search functionality, users can quickly find movies by title and access detailed information including plot summaries, cast, ratings, and more.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React JS</li>
